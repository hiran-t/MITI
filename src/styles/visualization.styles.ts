...
export const visualizationStyles = {
  ...
  viewer: {
    ...
    header: 'absolute top-3 left-3 z-10 px-3 py-1.5 bg-gray-900/90 rounded text-xs font-medium text-gray-300 border border-gray-800',
    statusBar: 'absolute top-3 right-3 z-10 px-3 py-1.5 bg-gray-900/90 rounded text-xs text-gray-400 border border-gray-800',
    statusBarLower: 'absolute top-3 right-3 z-10 flex items-center gap-2 px-3 py-1.5 bg-gray-900/90 rounded text-xs text-gray-400 border border-gray-800',
  ...
  camera: {
    ...
    title: 'flex items-center gap-2 px-3 py-1.5 bg-gray-900/90 rounded text-xs font-medium text-gray-300 border border-gray-800',
    titleIcon: 'w-4 h-4',
    select: 'px-3 py-1.5 bg-gray-900/90 rounded text-xs text-gray-300 border border-gray-800 focus:outline-none focus:border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed',
    ...
    loadingOverlay: 'absolute inset-0 bg-black/20 flex items-center justify-center pointer-events-none',
  ...
  pointcloud: {
    ...
    parsingBadge: 'absolute bottom-3 right-3 px-2 py-1 bg-yellow-500/20 rounded text-xs text-yellow-400 border border-yellow-500/30',
  },

  // Viewer controls
  controls: {
    container: 'absolute top-2 right-2 z-10 flex gap-2',
    button: 'p-2 bg-gray-900/80 hover:bg-gray-800/80 rounded border border-gray-700 transition-colors',
  ...
  urdf: {
    dropdown: {
      container: 'relative',
      trigger: 'flex items-center gap-2 px-3 py-1.5 bg-gray-800 hover:bg-gray-800 rounded-lg border border-gray-700 hover:border-gray-600 transition-all text-sm font-medium',
      icon: 'w-4 h-4',
      ...
      panel: 'absolute left-0 top-full mt-1 w-80 bg-gray-900 border border-gray-800 rounded-lg shadow-xl z-[60] overflow-hidden',
    },
    tabs: {
      container: 'flex border-b border-gray-800',
      button: 'flex-1 flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium transition-colors',
    ...
    form: {
      ...
      input: 'w-full px-3 py-1.5 bg-gray-800 border border-gray-700 rounded text-sm text-gray-200 focus:outline-none focus:border-blue-500',
      hint: 'mt-1.5 text-xs text-gray-500',
      select: 'w-full px-3 py-1.5 bg-gray-800 border border-gray-700 rounded text-sm text-gray-200 focus:outline-none focus:border-blue-500 disabled:opacity-50',
      loadButton: 'w-full flex items-center justify-center gap-2 px-3 py-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white text-sm font-medium rounded transition-all disabled:opacity-50 disabled:cursor-not-allowed',
      loadIcon: 'w-4 h-4',
  ...
  urdfSettings: {
    container: 'relative',
    triggerButton: 'flex items-center gap-1.5 px-3 py-1.5 hover:bg-gray-800/50 rounded-lg transition-colors border border-gray-800 hover:border-gray-700',
    ...
    dropdown: 'absolute right-0 top-full mt-2 w-80 max-h-[32rem] overflow-y-auto bg-gray-900 border border-gray-800 rounded-lg shadow-xl z-50',
    ...
    topicInput: 'flex-1 px-2 py-1.5 bg-gray-800 text-gray-200 text-xs rounded border border-gray-700 focus:border-blue-500 focus:outline-none',
    addButton: 'px-2 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded transition-colors',
    addIcon: 'w-4 h-4',
    topicList: 'space-y-1.5',
    topicItem: 'flex items-center justify-between p-2 bg-gray-800/50 rounded border border-gray-700',
    topicName: 'text-xs text-gray-300 truncate flex-1',
    removeButton: 'ml-2 p-1 text-red-400 hover:bg-red-500/20 rounded transition-colors flex-shrink-0',
    removeIcon: 'w-3.5 h-3.5',
    emptyState: 'text-xs text-gray-500 italic',
    // Presets
    presetsList: 'space-y-1.5',
    presetItem: 'group relative',
    presetButton: 'w-full text-left p-2 bg-gray-800/50 hover:bg-gray-800 rounded border border-gray-700 hover:border-gray-600 transition-colors',
    ...
    deleteButton: 'flex-shrink-0 p-1 text-red-400 hover:bg-red-500/20 rounded transition-colors opacity-0 group-hover:opacity-100',
    ...
    button: 'p-2 bg-gray-900/90 hover:bg-gray-800/90 rounded border border-gray-700 transition-colors',
    icon: 'w-4 h-4 text-gray-300',
    panel: 'absolute right-0 top-full mt-2 w-80 bg-gray-900 border border-gray-800 rounded-lg shadow-xl overflow-hidden',
    ...
    checkbox: {
      ...
      input: 'w-4 h-4 rounded border-gray-700 bg-gray-800 text-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0',
  ...
  loadStatus: {
    // Full overlay status
    overlay: 'absolute inset-0 flex items-center justify-center bg-gray-950/90 backdrop-blur-sm z-20',
    ...
    progressFill: 'bg-gradient-to-r from-lime-400 to-cyan-400 h-2 rounded-full transition-all duration-300',
    ...
    successCloseButton: 'absolute top-3 right-3 p-1 hover:bg-green-500/20 rounded transition-colors',
    ...
    inlineLoading: 'flex items-center gap-3 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg',
